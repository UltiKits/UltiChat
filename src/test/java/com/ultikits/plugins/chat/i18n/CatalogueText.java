...
import com.ultikits.plugins.chat.i18n.UltiChatLanguageCatalogueTest.Catalogue;
 ...
 * ({@link UltiChatLanguageCatalogueTest#loadModuleCatalogues()}: the framework's own {@link Language},
...
public final class CatalogueText {
    ...
    public static Map<String, String> entries(String code) {
        try {
            for (Catalogue c : UltiChatLanguageCatalogueTest.loadModuleCatalogues()) {
